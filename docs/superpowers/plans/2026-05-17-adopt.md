...
Replace the `Adopt`, `copyFile`, and `actionsFor` stubs in `internal/adopter/adopter.go`. All imports are already present from the skeleton — do not add duplicates:
